...
export const challengeDescription = [
  {
    title: '챌린지 시작과 종료',
    description:
      '챌린지는 한국시간으로 매일 오전 4시에 시작해서 다음날 오전 4시에 끝납니다.',
  },
  {
    title: '할 일 생성 및 완료',
    description:
      '챌린지 내에서 자신만의 할 일을 만들고, 이를 완수할 수 있어요.',
  },
  {
    title: '하루 마무리',
    description:
      "매일 한 번, '하루 완료하기' 기능을 통해 그날의 활동을 마무리할 수 있습니다.",
  },
  {
    title: '챌린지 달성도 상승',
    description:
      '하루 완료하기를 마무리하면, 챌린지 기간 동안 달성도가 올라가게 됩니다.',
  },
  {
    title: '폭탄 아이템',
    description:
      '일정 확률로 얻게되는 폭탄 아이템은 상대방에게 나의 목표 하나를 랜덤으로 줄 수 있어요',
  },
];
